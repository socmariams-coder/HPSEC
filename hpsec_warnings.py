...
WARNING_DEFINITIONS = {
    ...
    "IMP_ORPHAN_FILES": (WarningLevel.WARNING, "Fitxers orfes: {files} → Assignar a Importar", True),
...
ANOMALY_CATALOG = {
    ...
    # Només 3 codis actius — els 10 antics han estat eliminats (sorollosos, no accionables)
    "KHP_TIMEOUT_PEAK": {
        "severity": WarningLevel.BLOCKER,
